...
TURTLEBOT_NAME = "turtle_1"

class TurtleBot3:

    def __init__(self):
        rospy.init_node('move_to_goal', anonymous = True)
        self.sub  = rospy.Subscriber('/'+TURTLEBOT_NAME+'/odom', Odometry, self.get_odom  )
        self.pub  = rospy.Publisher( '/'+TURTLEBOT_NAME+'/cmd_vel', Twist, queue_size = 10)
